...
class _$ToDoDAO extends ToDoDAO {
  ...
  @override
  Future<void> insertItem(ToDoItem i) async {
    await _toDoItemInsertionAdapter.insert(i, OnConflictStrategy.abort);
  }

  @override
  Future<void> deleteItem(ToDoItem i) async {
    await _toDoItemDeletionAdapter.delete(i);
  }
}
